 ...
 */
typedef NS_ENUM(NSInteger, BCMTDateWeekNumberingSystem) {
    /**
     *  First week contains January 1st.
     */
    BCMTDateWeekNumberingSystemUS       = 1,
    /**
     *  First week contains january 4th.
     */
    BCMTDateWeekNumberingSystemISO      = 4,
    /**
     *  First week starts on January 1st, next on Jan 8th, etc.
     */
    BCMTDateWeekNumberingSystemSimple = 8
};

/**
 *  Hour format
 */
typedef NS_ENUM(NSInteger, BCMTDateHourFormat) {
    /**
     *  e.g. 23:00
     */
    BCMTDateHourFormat24Hour,
    /**
     *  e.g. 11:00pm
     */
    BCMTDateHourFormat12Hour
};
...
// This is exact.
static NSInteger const BCMTDateConstantSecondsInMinute   = 60;

// This is exact.
static NSInteger const BCMTDateConstantSecondsInHour     = 60 * 60;

// This is not always true. Leap year/DST.
static NSInteger const BCMTDateConstantSecondsInDay      = 60 * 60 * 24;

// This is not always true. Leap year/DST.
static NSInteger const BCMTDateConstantSecondsInWeek     = 60 * 60 * 24 * 7;

// This is an approximation and rarely true.
static NSInteger const BCMTDateConstantSecondsInMonth    = 60 * 60 * 24 * 7 * 30;

// This is true 3 out of 4 years. Leap years have 366 days.
static NSInteger const BCMTDateConstantSecondsInYear     = 60 * 60 * 24 * 7 * 365;

// This is exact.
static NSInteger const BCMTDateConstantDaysInWeek        = 7;

// This is not always true. Daylight savings time can increate/decrease a days hours by 1.
static NSInteger const BCMTDateConstantHoursInDay        = 24;
...
+ (void)mt_setWeekNumberingSystem:(BCMTDateWeekNumberingSystem)system;
...
- (NSString *)mt_stringFromDateWithHourAndMinuteFormat:(BCMTDateHourFormat)format;
...
extern NSString *const BCMTDatesFormatDefault;          // Sat Jun 09 2007 17:46:21
extern NSString *const BCMTDatesFormatShortDate;        // 6/9/07
extern NSString *const BCMTDatesFormatMediumDate;       // Jun 9, 2007
extern NSString *const BCMTDatesFormatLongDate;         // June 9, 2007
extern NSString *const BCMTDatesFormatFullDate;         // Saturday, June 9, 2007
extern NSString *const BCMTDatesFormatShortTime;        // 5:46 PM
extern NSString *const BCMTDatesFormatMediumTime;       // 5:46:21 PM
extern NSString *const BCMTDatesFormatLongTime;         // 5:46:21 PM EST
extern NSString *const BCMTDatesFormatISODate;          // 2007-06-09
extern NSString *const BCMTDatesFormatISOTime;          // 17:46:21
extern NSString *const BCMTDatesFormatISODateTime;      // 2007-06-09T17:46:21
//extern NSString *const BCMTDatesFormatISOUTCDateTime;   // 2007-06-09T22:46:21Z