...
@class BCGCDMulticastDelegateEnumerator;
...
@interface BCGCDMulticastDelegate : NSObject
...
- (BCGCDMulticastDelegateEnumerator *)delegateEnumerator;

@end


@interface BCGCDMulticastDelegateEnumerator : NSObject
